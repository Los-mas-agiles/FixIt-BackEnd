...
1. **Cadena de modelos** (\`IA_MODELOS\`, en orden): si uno está saturado (503), sin cuota (429), no responde a tiempo o responde algo inválido, se prueba el siguiente. Cada modelo tiene como mucho 4 s (para dejar tiempo al siguiente) y el total nunca pasa de 8 s.
